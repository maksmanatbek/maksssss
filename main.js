...
const messages = [
"🌸 Құрметті 11”В” арулары 🌸Бүгін ерекше күн! Біз сіздерді құттықтағымыз келеді! 🎉",  
"Сіздер – сұлулық пен мейірімнің, қуаныш пен шабыттың көзісіздер! 🌷 Әр күніңіз қуанышқа, жылулыққа және махаббатқа толы болсын! 💖"
,  
"Осы тамаша күнді бірге атап өтейік! ☕🍰 Сіздерді мектеп артындағы үйде(Ақсұңқардың) күтеміз!",  
"Көңілді кеш, дәмді тағам жеп қырылып қайтамыз! 😍 Келіңіздер, бірге ұмытылмас сәттер сыйлайық!",   
"Адрестеу 💝"
];
